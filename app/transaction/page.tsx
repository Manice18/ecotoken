import { SideBar, SearchBar, Transaction } from '@/app/components';
import { ngoDashboard } from '@/app/utils';
function Page() {
  return (
    <>
      <div className='flex h-screen flex-col bg-[#171819] md:flex-row'>
        ...
        <div className=' flex h-screen w-screen flex-col'>
          ...
          <div className='mx-auto mb-5 grid h-[15vh] w-[76vw] grid-cols-3 space-x-1 divide-x divide-[#3F4042] rounded bg-[#202123] p-5 text-left text-[15px] text-gray-400'>
