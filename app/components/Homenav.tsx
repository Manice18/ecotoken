...
function Homenav() {
  ...
  return (
    <div className='sticky flex h-10 flex-row items-center bg-white p-10 text-black'>
      <div className='cursor-pointer text-3xl font-semibold text-[#54b946]'>
        EcoToken
      </div>
      <div className='relative left-[60%] flex flex-row items-center gap-6'>
        ...
        <button
          className='rounded-lg bg-[#54b946] p-3 text-white'
          onClick={() => {
            push('login');
          }}
        >
