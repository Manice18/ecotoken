...
import { REFI_PROGRAM_PUBKEY } from '@/app/utils';
import refiIDL from '@/app/utils/constants/refi.json';
        ...
        try {
          if (typeOfAccount === 'INVESTOR') {
            ...
            const profileAccount =
              await program.account.investorProfile.fetch(profilePda);
            ...
            const profileAccount =
              await program.account.ngoProfile.fetch(profilePda);
